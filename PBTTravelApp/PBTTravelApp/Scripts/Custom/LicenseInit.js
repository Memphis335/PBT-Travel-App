...
LicenseInit = function () {
    var b = function () {
        ...
        c = function () {
            var d;
            var e =
                "$select=ID,TrialStartDate,ActivationKey,IsInitialized,IsValid";
            $.ajax({
                url: appweburl +
                    "/_api/Web/lists/getbytitle('Licenses')/items?" +
                    e,
                type: "GET",
                async: false,
                cache: false,
        ...
        a = function (d) {
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    ...
                    Title: "",
                    TrialStartDate: moment(d).format(
                        sharepointDateFormat),
